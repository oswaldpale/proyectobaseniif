...
<body>
    ...
    <form id="form1" runat="server" >
     <ext:Viewport ID="Viewport1" runat="server" >
        ...
        <Items>
             <ext:FormPanel ID="FormVentana" runat="server"  Frame="true" Width="1200" Height="530">
                    <Items>
                ...
                <Items>
                    ...
                    <ext:Container ID="Container19" runat="server" Layout="HBoxLayout">
                        ...
                        <Items>
                            ...
                            <ext:Hidden ID="idcomponente" runat="server" />
                            <ext:Hidden ID="norma" runat="server" />
                            <%--************ Filtro de clase***************--%>
                            ...
                            <Items>
                                ...
                                <ext:Panel ID="Panel11" runat="server" Title="Componente" UI="Info" >
                                    <Items>
                                        <ext:FormPanel ID="FormPanel2" runat="server" ButtonAlign="Center" Disabled="true" UI="Primary">
                                            <Items>
                                                <ext:Container ID="Container2" runat="server" Layout="HBoxLayout">
                                                    <Items>
                                                        <ext:Label ID="lbl_nombre" runat="server" Text="Nombre" Flex="4" Enabled="true" Margins="5 25 0 10" />
                                                         <ext:Label ID="Label5" runat="server" Text="Norma" Flex="3" Enabled="true" Margins="5 20 0 10" />
                                                        <ext:Label ID="lbl_porcentaje" runat="server" Text="Porcentaje " Flex="1" Enabled="true" Margins="5 5 0 10" />
                                                        <ext:Label ID="lbl_tipo" runat="server" Text="Tipo Depreciacion" Flex="3" Enabled="true" Margins="5 15 0 10" />
                                                        <ext:Label ID="lbl_vidautil" runat="server" Text="Vida Util" Flex="1" Enabled="true" Margins="5 15 0 10" />
                                                       
                                                        <ext:Label ID="lbl_medida" runat="server" Text="Medida" Flex="2" Enabled="true" Margins="5 15 0 10" />
                                                       <ext:Label ID="Label6" runat="server" Text="" Flex="2" Enabled="true" Margins="5 15 0 10" />
                                                    </Items>
                                                </ext:Container>
                                                    ...
                                                    <Items>
                                                        <ext:TextField ID="txt_nombre" runat="server" Flex="4" Margins="0 0 15 10" AllowBlank="false" />
                                                          ...
                                                          <ext:ComboBox runat="server" ID="cbx_norma" Icon="SectionCollapsed"
                                                            ...
                                                            <Listeners>
                                                                <Select Handler="App.direct.Nlocalporc(App.cbx_norma.getValue(),App.cbx_norma.getDisplayValue());" />
                                                            </Listeners>
                                                        </ext:ComboBox>
                                      ...
                                      <Select Handler="App.direct.formato_VidaUtil(#{cbx_tipo_depreciacion}.getValue())" />
                                                        ...
                                                        <ext:Button ID="btn_agregar" FormBind="true" runat="server" Width="140" Margins="0 10 15 10" Text="Agregar" Icon="Add" UI="Primary">
                                                            <Listeners>
                                                                <Click Handler="App.direct.GuardarComponente([
                                                                  ...
                                                                  App.cbx_norma.getValue()  
                                                                    ], App.GridPanel3.getStore().getRecordsValues())" />
                                                            </Listeners>
                                                        </ext:Button>
                                                        <ext:Button ID="BtnActComp" FormBind="true" runat="server" Hidden="true" Flex="2" Margins="0 10 15 10" Text="Actualizar"  UI="Primary">
                                                            <Listeners>
                                                                <Click Handler="App.direct.ActualizarComponente([
                                                                  App.txt_nombre.getValue(),
                                                                  App.txt_porcentajeComponente.getValue(),
                                                                  App.txt_vidautil.getValue(),
                                                                  App.cbx_tipo_depreciacion.getValue(),                                                                  
                                    ...
                                    <Items>
                                        <ext:GridPanel ID="GridPanel3" runat="server" Flex="1" Height="350" Border="true">
                                            <Store>
                                            ...
                                            <ColumnModel ID="ColumnModel2" runat="server">
                                                <Columns>
                                                    <ext:Column ID="Column17" runat="server" DataIndex="codigo" Header="Codigo"
                                                        Width="70">
                                                    </ext:Column>
                                                    ...
                                                    <ext:Column ID="Column22" runat="server" DataIndex="subclase" Header="Subclase" Width="100">
                                                     ...
                                                     <ext:Column ID="Column16" runat="server" DataIndex="norma" Header="Norma" Flex="2">
                                                    </ext:Column>
                                            ...
                                            <Features>
                                             ...
                                             <SelectionModel>
                                                <ext:RowSelectionModel ID="RowSelectionModel1" runat="server" Mode="Single">
                                                    <Listeners>
                                                        <Select Handler="App.direct.CargarDatosComponentes(record.data.codigo);">
                                                        </Select>
                                                    </Listeners>
                                ...
                                <ext:Panel ID="Panel4" runat="server" Title="Caracteristicas" UI="Info">
                                    <Items>
                                        ...
                                        <ext:GridPanel ID="GridPanel2" runat="server" Flex="1" Height="350" Border="true">
                                            <Store>
                                            ...
                                            <SelectionModel>
                                                <ext:RowSelectionModel ID="RowSelectionModel6" runat="server" Mode="Single">
                                                    <Listeners>
                                                        <Select Handler="App.direct.CargarDatos(record.data['idcargo']);">
                                                        </Select>
                                                    </Listeners>
                                                </ext:RowSelectionModel>
                                            </SelectionModel>
