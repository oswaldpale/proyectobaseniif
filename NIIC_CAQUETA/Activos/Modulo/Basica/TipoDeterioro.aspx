<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TipoDeterioro.aspx.cs" Inherits="Activos.Modulo.TipoDeterioro" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>TIPO DETERIORO</title>
    <style type="text/css">
        /**/
	    #unlicensed{
                ...
                <Items>
                    ...
                    <ext:Container ID="Container1" runat="server" Layout="HBoxLayout">
                        <Items>
                            ...
                            <ext:Label ID="lbl_tipo" runat="server" Html ="TIPO<font color ='red'>*</font>"  Width="60" Enabled="true"
                                Margins="10 0 10 10" />
                            <ext:TextField ID="txt_tipo" runat="server" Flex="2" Disabled="false" Margins="10 0 10 10" AllowBlank="false"
                                EmptyText="" />
                           
                            <ext:Button ID="btn_creartipo" runat="server" Flex="1" Icon="Disk" Text="Guardar" Margins="10 0 0 10" >
                                <Listeners>
                                    <Click Handler="if(App.FormPanel1.isValid()){App.direct.Guardar(
                                    App.GridPanel1.getStore().getRecordsValues(),                                    
                                    App.txt_tipo.getValue()
                                    );
                                    }else{true}
                                    " />
                                </Listeners>
                             ...
                             <ext:Panel ID="Panelmotivo" runat="server" Flex="1" Margins="10 0 0 10">
                                <Items>
                                    <ext:GridPanel ID="GridPanel1" runat="server" Flex="1" Height="250" Border="true">
                                        <Store>
                                            <ext:Store ID="store_tipo" runat="server" >
                                                <Model>
                                        ...
                                        <ColumnModel ID="ColumnModel2" runat="server">
                                            <Columns>  
                                                ...
                                                <ext:Column ID="Column1" runat="server" DataIndex="tipo" Text="TIPO DETERIORO"
                                                    Flex="4">
                                                    <Editor>
                                               ...
                                               <ext:CommandColumn ID="CommandColumn8" runat="server" Align="Center" Width="27">
                                                        ...
                                                        <Listeners>
                                                            <Command Handler="App.GridPanel1.getStore().remove(record);App.direct.Eliminartipo(record.data.codigo)" />
                                                        </Listeners>
                                                    </ext:CommandColumn>
                                            </Columns>
                                        </ColumnModel>
