<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MotivoDeterioro.aspx.cs" Inherits="Activos.Modulo.MotivoDeterioro" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>MOTIVO DETERIORO</title>
    <style type="text/css">
        /**/
	    #unlicensed{
                                    ...
                                    <ext:GridPanel ID="GridPanel1" runat="server" Flex="1" Height="250" Border="true">
                                        ...
                                        <ColumnModel ID="ColumnModel2" runat="server">
                                            <Columns>   
                                                ...
                                                <ext:Column ID="Column1" runat="server" DataIndex="motivo" Text="MOTIVO DETERIORO"
                                                    Flex="4">
                                                    <Editor>
