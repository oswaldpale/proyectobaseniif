<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Propiedad.aspx.cs" Inherits="Activos.Modulo.Propiedad" %>
...
<body>
    ...
    <ext:Hidden ID="idpropiedad" runat="server" />
                ...
                <Items>
                    <ext:Container ID="Container3" runat="server" Layout="HBoxLayout">
                        <Items>
                            ...
                            <ext:Label ID="lbl_costo" runat="server" Html="Propiedad<font color ='red'>*</font>" Flex="3" Enabled="true"
                                Margins="5 0 0 5" />
                    ...
                    <ext:Container ID="Container1" runat="server" Layout="HBoxLayout">
                        <Items>
                            ...
                            <ext:TextField ID="txt_propiedad" runat="server" Flex="3" Disabled="false" Margins="5 0 0 5" AllowBlank="false"
                                EmptyText="" />
                             ...
                             <ext:Panel ID="Paneleconomico" runat="server" Flex="1" Margins="5 0 0 5">
                                <Items>
                                    <ext:GridPanel ID="GridPanel1" runat="server" Flex="1" Height="330" Border="true">
                                        <Store>
                                            <ext:Store ID="store_propiedad" runat="server" >
                                                <Model>
                                                    <ext:Model ID="Model5" runat="server" IDProperty="idpropiedad">
                                                        <Fields>   
                                                            <ext:ModelField Name="idpropiedad" />
                                                            <ext:ModelField Name="propiedad" />  
                                        ...
                                        <ColumnModel ID="ColumnModel2" runat="server">
                                            <Columns>        
                                                <ext:Column ID="Column2" runat="server" DataIndex="idpropiedad" Text="CODIGO" />                                           
                                                <ext:Column ID="Column1" runat="server" DataIndex="propiedad" Text="TIPO PROPIEDAD"
                                                    Flex="1">
                                                    <HeaderItems>
                                       ...
                                       <SelectionModel>
                                            <ext:RowSelectionModel ID="RowSelectionModel6" runat="server" Mode="Single">
                                                <Listeners>
                                                    <Select Handler="App.direct.CargarDatos(record.data['idpropiedad']);">
                                                    </Select>
                                                </Listeners>
