<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TipoActivo.aspx.cs" Inherits="Activos.Modulo.TipoActivo" %>
...
<body>
    ...
    <ext:Hidden ID="idtipo" runat="server" />
                ...
                <Items>
                    <ext:Container ID="Container3" runat="server" Layout="HBoxLayout">
                        <Items>
                            ...
                            <ext:Label ID="lbl_costo" runat="server" Html="Tipo Activo<font color ='red'>*</font>" Flex="3" Enabled="true"
                                Margins="5 0 0 5" />
                    ...
                    <ext:Container ID="Container1" runat="server" Layout="HBoxLayout">
                        <Items>
                            ...
                            <ext:TextField ID="txt_tipo" runat="server" Flex="3" Disabled="false" Margins="5 0 0 5" AllowBlank="false"
                                EmptyText="" />
                                    ...
                                    <ext:GridPanel ID="GridPanel1" runat="server" Flex="1" Height="330" Border="true">
                                        <Store>
                                            <ext:Store ID="store_tipo" runat="server" >
                                                <Model>
                                                    <ext:Model ID="Model5" runat="server" IDProperty="idtipo">
                                                        <Fields>   
                                        ...
                                        <ColumnModel ID="ColumnModel2" runat="server">
                                            <Columns>        
                                                <ext:Column ID="Column2" runat="server" DataIndex="idtipo" Text="CODIGO" />                                           
                                                <ext:Column ID="Column1" runat="server" DataIndex="tipo" Text="TIPO ACTIVO"
                                                    Flex="1">
                                                    <HeaderItems>
                                       ...
                                       <SelectionModel>
                                            <ext:RowSelectionModel ID="RowSelectionModel6" runat="server" Mode="Single">
                                                <Listeners>
                                                    <Select Handler="App.direct.CargarDatos(record.data['idtipo']);">
                                                    </Select>
                                                </Listeners>
