<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CargoFuncionario.aspx.cs" Inherits="Activos.Modulo.CargoFuncionario" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>TIPO CARGO EMPLEADO</title>
...
<body>
    ...
    <ext:Hidden ID="idcargo" runat="server" />
                     ...
                     <ext:Container ID="Container3" runat="server" Layout="HBoxLayout">
                         <Items>
                              <ext:Label ID="Label2" runat="server" Html="Codigo<font color ='red'>*</font>" Flex="1" Enabled="true"
                               ...
                               <ext:Label ID="lbl_economico" runat="server" Html ="Cargo<font color ='red'>*</font>"  Flex="3" Enabled="true"
                                Margins="5 0 0 5" />
                    ...
                    <ext:Container ID="Container1" runat="server" Layout="HBoxLayout">
                        <Items>
                            <ext:TextField ID="txt_codigo" runat="server" Flex="1" Disabled="false" Margins="5 0 0 5" AllowBlank="false"
                                EmptyText="" />
                            <ext:TextField ID="txt_cargo" runat="server" Flex="3" Disabled="false" Margins="5 0 0 5" AllowBlank="false"
                                EmptyText="" />
                             ...
                             <ext:Panel ID="Paneleconomico" runat="server" Flex="1" Margins="10 0 0 10">
                                <Items>
                                    <ext:GridPanel ID="GridPanel1" runat="server" Flex="1" Height="330" Border="true">
                                        <Store>
                                            <ext:Store ID="store_cargo" runat="server" >
                                                <Model>
                                        ...
                                        <ColumnModel ID="ColumnModel2" runat="server">
                                            <Columns>   
                                                ...
                                                <ext:Column ID="Column1" runat="server" DataIndex="cargo" Text="DESCRIPCION"
                                                    Flex="1">
                                                    <HeaderItems>
