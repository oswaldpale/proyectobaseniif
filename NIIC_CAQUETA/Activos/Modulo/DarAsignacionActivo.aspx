<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DarAsignacionActivo.aspx.cs" Inherits="Activos.Modulo.AsignacionActivo" %>
<%@ Register Assembly="Ext.Net" Namespace="Ext.Net" TagPrefix="ext" %>
<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>ASIGNACION DE ACTIVO</title>
...
<body>
    <form id="form1" runat="server">
        <ext:ResourceManager ID="ResourceManager1" runat="server" Theme="Neptune" AjaxTimeout="560000" />
        ...
        <ext:Viewport ID="Viewport1" runat="server">
            ...
            <Items>
                <ext:Panel ID="Panel3" runat="server" Region="Center" BodyPaddingSummary="0 2 0 0" UI="Primary">
                    <Items>
                        <ext:FormPanel ID="FormPanel1" runat="server" Width="800" Frame="true"
                            ...
                            <Items>
                                ...
                                <ext:Hidden ID="NAsignacion" runat="server" />
                                ...
                                <ext:FieldSet ID="FRECUPERAR" runat="server" Disabled="false" Title="Recuperar" Collapsed="true" Collapsible="true">
                                    <Items>
                                        <ext:FormPanel runat="server" Padding="3">
                                            <Items>
                                                <ext:Label ID="LRECUPERAR" runat="server" Text="No. Ingreso" Width="100" Margins="10 0 0 10" />
                                            </Items>
                                            <Items>
                                                <ext:TextField ID="TRECUPERARASIGNACION" runat="server" Width="120" ReadOnly="true" FieldStyle="text-align:right;" Margins="10 0 0 10"
                                                    Selectable="false" Icon="Zoom" FieldCls="CampoReservado">
                                                    <Listeners>
                                                        <IconClick Handler="App.direct.RecuperarNoAsignacion();App.WRECUPERARASIGNACION.show();" />
                                                    </Listeners>
                                                </ext:TextField>
                                            </Items>
                                        </ext:FormPanel>
                                    ...
                                    <Items>
                                        <ext:Container ID="Container6" runat="server" Layout="HBoxLayout">
                                            <Items>
                                                ...
                                                <ext:Label ID ="lbl_nfactura" runat="server" Text="No. Ingreso" Width="100" Margins="5 0 0 5" />
                                                <ext:Label ID="lbl_fecha" runat="server" Html="Fecha Asignación<font color ='red'>*</font>" Width="140" Margins="5 0 0 5" />
                                                
                                            </Items>
                                        </ext:Container>
                                        <ext:Container ID="Container19" runat="server" Layout="HBoxLayout">
                                            <Items>
                                                <ext:TriggerField ID="TriggerField2" runat="server" Name="Buscar" TextAlign="Center" AllowBlank="false" Editable="false" FieldCls="text-center" Flex="3" Margins="0 0 0 5">
                                                    <Triggers>
                                                ...
                                                <ext:TriggerField ID="TriggerCentro" runat="server" Name="Buscar" TextAlign="Center" AllowBlank="false" Editable="false" FieldCls="text-center" Flex="3" Margins="0 0 0 5">
                                                    <Triggers>
                                                        <ext:FieldTrigger Icon="Search" />
                                                    </Triggers>
                                                    <DirectEvents>
                                                 ...
                                                 <ext:TextField ID ="txt_nfactura" runat="server" Width="100" ReadOnly="true" FieldStyle="text-align:right;" Margins="0 0 0 5"
                                                    Selectable="false" Icon ="Zoom" FieldCls="CampoReservado" >
                                                    <Listeners>
                                                ...
                                                <ext:DateField ID="dfd_fecha" runat="server" Editable="false" FieldStyle="text-align: center;" 
                                                    Margins="0 0 0 5" Width="140" Format="yyyy-MM-dd" AllowBlank="false" EnableKeyEvents="true">
                                                </ext:DateField>
                                        ...
                                        <ext:Container ID="Container4" runat="server" Layout="HBoxLayout">
                                            <Items>
                                                ...
                                                <ext:ComboBox runat="server" ID="cbx_economico" Icon="SectionCollapsed" EmptyText="Select" AutoDataBind="true"
                                                    ForceSelection="true" Margins="0 0 0 5" Flex="1"
                                                ...
                                                <ext:ComboBox runat="server" ID="cbx_motivo" Icon="SectionCollapsed" EmptyText="Select" AutoDataBind="true"
                                                    ForceSelection="true" Margins="0 0 0 5" Flex="1"
                                                    ...
                                                    <Listeners>
                                                        <Change Handler = "if(App.cbx_motivo.getValue()==2){App.direct.CambiaReasignacion();}" />
                                                    </Listeners>
                                                </ext:ComboBox>
                                        ...
                                        <ext:Container ID="Container1" runat="server" Layout="HBoxLayout">
                                            <Items>
                                                <ext:TextArea ID="txt_conceptos" runat="server" Margins="0 0 15 5" AllowBlank="true"
                                    ...
                                    <Items>
                                        ...
                                        <ext:Container ID="Container2" runat="server" Layout="HBoxLayout">
                                            <Items>
                                                ...
                                                <ext:ComboBox runat="server" ID="cbx_dependencia" Icon="SectionCollapsed" EmptyText="Select" AutoDataBind="true"
                                                    ForceSelection="true" Margins="0 0 0 5" Flex="1"
                                        ...
                                        <ext:Container runat="server">
                                            <Items>
                                                <ext:GridPanel ID="GridPanel3" runat="server" Height="290" Margins="0 0 15 0" Border="true">
                                                    <Store>
                            ...
                            <FooterBar>
                                         ...
                                         <ext:Button runat="server" ID="btn_reporte" Text="REPORTE..." Icon="Printer" Scale="Small">
                                            <Listeners>
                                                <Click Handler="
                                                    ...
                                                    App.direct.Informe_AsignacionActivo_RptDetalle(  
                                        ...
                                        <Click Handler= " var r = App.GridPanel3.getStore().count();
                                             if(r != 0 ) {
                                                if(App.FpanelGeneral.isValid()){ 
                                                    App.direct.ActualizarAsignacion(#{GridPanel1}.getStore().getRecordsValues());
                                                }else{true} 
                                            }else{
                                                Ext.Msg.show({
                                ...
                                <ext:Button ID="BTNGUARDAREASIGANCION" runat="server" Text="GRABAR" Icon="Disk"  Width="100" Hidden="true"
                                     ToolTip="Agregar Asignacion." Margins="0 0 15 10">
                                    <Listeners>
                                        <Click Handler="
                                             var r = App.GridPanel3.getStore().count();
                                             if(r != 0 ) {
                                                if(App.FpanelGeneral.isValid()){ App.direct.grabarReasignacion(
                                                #{GridPanel1}.getStore().getRecordsValues()
                                                );
                                                }else{true} 
                                            }else{
        ...
        <Items>
            <ext:GridPanel ID="GridActivo" runat="server" Title="Comodatos" UI="Info" Border="true" Height="360">
                ...
                <ColumnModel ID="ColumnModel2" runat="server">
                    <Columns>
                        <ext:Column ID="Column5" runat="server" Text="No Ingreso" DataIndex="NFactura" Align="Center" Width="120">
                            <HeaderItems>
    ...
    <ext:Window ID="win_centroCosto" runat="server" Hidden="true" Width="500" Title="Detalle Centro Costo">
                ...
                <Items>
                    ...
                    <ext:Container runat="server" Layout="HBoxLayout">
                        <Items>
                              ...
                              <ext:DropDownField ID="Drop2" runat="server" FieldStyle="text-align: center;" Editable="false"  AllowBlank="false"
     ...
     <ext:Window ID="WRECUPERARASIGNACION" runat="server" Header="false" Shadow="false" StyleSpec="border: 0;" Modal="true" Hidden="true" Width="650">
        <Items>
            <ext:GridPanel ID="GRECUPERACION" runat="server" Title="RECUPERAR ASIGNACIÓN" UI="Info" Border="true" Height="360">
                <Tools>
                    <ext:Tool ID="TRECUPERACION" Type="Close">
                        <Listeners>
                            <Click Handler=" #{WRECUPERARASIGNACION}.hide(); " />
                        </Listeners>
                    </ext:Tool>
                </Tools>
                <Store>
                ...
                <ColumnModel ID="ColumnModel8" runat="server">
                    <Columns>
                        ...
                        <ext:Column ID="CFecha" runat="server" Text="Fecha" DataIndex="FechaRegistro" Align="Center" Width="100">
                            <HeaderItems>
                                <ext:TextField ID="TextField16" runat="server" FieldCls="text-center">
                                        <Listeners>
                                            <Change Handler="this.up('grid').applyFilter();" />
                                        </Listeners>
                                        <Plugins>
                        ...
                        <ext:Column ID="CObservación" runat="server" Text="Observación" DataIndex="Observacion" Flex="1">
                             <HeaderItems>
                                    <ext:TextField ID="TextField15" runat="server" FieldCls="text-center">
                                        <Listeners>
                                            <Change Handler="this.up('grid').applyFilter();" />
                                        </Listeners>
                                        <Plugins>
                ...
                <DirectEvents>
                    <ItemDblClick OnEvent="GRRECUPERACIONASIGNACION" After="#{TRECUPERACION}.fireEvent('click');">
                        <ExtraParams>
